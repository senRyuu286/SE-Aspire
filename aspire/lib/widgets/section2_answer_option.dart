...
class Section2AnswerOption extends StatelessWidget {
  const Section2AnswerOption({super.key, required this.assignedAnswerIndex, required this.ref, required this.questionID});
  ...
  Widget build(BuildContext context) {
    ...
    List<String> likertScaleText = ["1: Beginner/Hard", "2: Novice/Challenging", "3: Competent/Average", "4: Proficient/Manageable", "5: Expert/Easy"];
